  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all animate-fadeInUp">
          {/* Icon */}
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className={`flex-1 px-4 py-3 text-white rounded-lg transition font-semibold ${typeStyles[type]}`}
            >
              {confirmText}
            </button>
          </div>
