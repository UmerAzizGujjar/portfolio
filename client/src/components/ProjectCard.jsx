  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          <div 
            className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[80vh] overflow-y-auto animate-slideInUp"
          ...
          >
            ...
            {/* Modal Content - Only Description */}
            <div className="p-8">
              {/* Project Title as Heading */}
              <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
                {project.title}
              </h2>
