        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
              {/* Contact Form */}
              <div className="animate-fadeInUp w-full min-w-0" style={{ animationDelay: '0.2s' }}>
                <ContactForm />
              </div>

              {/* Contact Info */}
              <div className="space-y-4 sm:space-y-6 animate-fadeInUp w-full min-w-0" style={{ animationDelay: '0.3s' }}>
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20 shadow-xl">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-4 sm:mb-6">Contact Information</h3>
                  
                  <div className="space-y-4 sm:space-y-6">
                    {bio?.email && (
                      <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition min-w-0">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-400 to-purple-400 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <a href={`mailto:${bio.email}`} className="text-sm sm:text-base text-white font-semibold hover:text-blue-400 transition break-all">
                            {bio.email}
                          </a>
                        </div>
                      </div>
                    ...
                    {bio?.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover:bg-white/20 transition-all min-w-0"
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm sm:text-base text-white font-semibold group-hover:text-blue-400 transition truncate">View Profile</p>
                        </div>
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:translate-x-1 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
                      </a>
                    )}
                    ...
                    {bio?.linkedin && (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm sm:text-base text-white font-semibold group-hover:text-blue-400 transition truncate">Connect With Me</p>
                        </div>
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:translate-x-1 transition-transform flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
